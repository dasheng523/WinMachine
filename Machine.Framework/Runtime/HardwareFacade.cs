...
public interface IHardware
{
    ...
    IResolver<ISensor<Machine.Framework.Core.Core.Level>> LevelSensors { get; }
...
public sealed class HardwareFacade : IHardware
{
    public HardwareFacade(
        ...
        IResolver<ISensor<Machine.Framework.Core.Core.Level>> levelSensors,
    ...
    public IResolver<ISensor<Machine.Framework.Core.Core.Level>> LevelSensors { get; }
    ...
    private sealed class AxisAsHardwareResolver : IResolver<IAxis>
    {
        ...
        {
            private readonly Machine.Framework.Devices.Motion.Abstractions.IMotionController<ushort, ushort, ushort> _controller;
            private readonly ushort _axis;

            public MotionAxis(string name, Machine.Framework.Devices.Motion.Abstractions.IMotionController<ushort, ushort, ushort> controller, ushort axis)
            {
                Name = name;
