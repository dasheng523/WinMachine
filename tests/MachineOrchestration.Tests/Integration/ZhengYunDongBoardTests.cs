...
public class ZhengYunDongBoardTests : IDisposable
{
    private readonly MockZhengYunDongSdk _mockSdk;
    private readonly ZhengYunDongBoard _board;
    private readonly ZhengYunDongBoardConfig _config;

    public ZhengYunDongBoardTests()
    {
        _mockSdk = new MockZhengYunDongSdk(simulateErrors: false);
        _config = new ZhengYunDongBoardConfig(
        ...
        _board = new ZhengYunDongBoard(_mockSdk, _config);
    }
    ...
    {
        // Arrange
        var failingSdk = new MockZhengYunDongSdk(simulateErrors: true, errorProbability: 1.0);
        var failingBoard = new ZhengYunDongBoard(failingSdk, _config);
